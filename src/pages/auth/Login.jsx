    ...
    return (
        <div className="login-page">
            <div className="login-title">
                <h2 className="font-semibold text-2xl">Sign-In to <span className="text-primary-400">Expense</span><span className="text-secondary-500">Vouge</span></h2>
            </div>
            <div className="login-cont">
                    <div className="login-btn group flex flex-row gap-2 items-center justify-center" onClick={signInWithGoogle}>
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48" className="w-5 h-5">
                            ...
                            <p className="group-hover:text-primary-300">Sign-In with Google</p>
                    </div>
