    ...
    return(
        <div className="register-page">
            <div className="login-title">
                <h2 className="font-semibold text-2xl">Sign-Up to ExpenseVouge</h2>
            </div>
            <div className="login-cont">
                    <div className="login-btn  flex flex-row gap-3 justify-center items-center" onClick={signInWithGoogle}>
                ...
                <div className="flex flex-col items-center gap-3">
                    ...
                    <button className="login-btn hover:bg-indigo-500 mb-4" onClick={() => {
                        signUp(nameValue, emailValue, passwordValue)
                        setMsg(getMsg())
                        }} type="submit">Create account</button>
                    <p>Already have an account? <Link to="/login"><span className="text-blue-600 hover:underline">Login</span></Link></p>
                </div>
            </div>
        </div>
    )
